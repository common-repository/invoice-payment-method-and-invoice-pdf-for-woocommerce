	...
	<div class="af-pdf-wrapper">
			<section class="af-pdf-header">
				...
				<div class="af-invoice-info-box">
					<h2><?php esc_html_e( 'Proforma Invoice', 'af_ips_invoices' ); ?></h2>
			...
			<section class="af-line-temp-mid-section">
				...
				<div class="af-line-temp-mid-sec-left">
					<h4><?php esc_html_e( 'Customer Detail', 'af_ips_invoices' ); ?></h4>
					<ul>
						<li><p><label><?php echo esc_html__( 'Contact Name:', 'af_ips_invoices' ); ?></label> <span><?php echo esc_attr( $shipping_first_name ); ?></span></p></li>
